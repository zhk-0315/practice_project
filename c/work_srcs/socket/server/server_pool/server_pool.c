...
void create_server_thread_pool(void)
{
    ...
    g_thread_pool = create_thread_pool(6, 10);
}
...
void add_task_to_server_pool_use_arg_mem(void* (*handler)(void*), void* arg)
{
    ...
    return add_task_to_pool_use_arg_mem(g_thread_pool, handler, arg);
}
    ...
    void* arg, size_t arg_size)
{
    ...
    return add_task_to_pool_release_arg_mem(g_thread_pool, handler, arg, arg_size);
}